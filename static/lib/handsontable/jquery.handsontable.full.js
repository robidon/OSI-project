...
CopyPasteClass.prototype.init = function () {
  ...
  this.keydownListener = function (event) {
    ...
    if (isCtrlDown) {
      if (document.activeElement !== that.elTextarea && (document.activeElement.contentEditable==='true' || that.getSelectionText() != '' || ['INPUT', 'SELECT', 'TEXTAREA'].indexOf(document.activeElement.nodeName) != -1)) {
